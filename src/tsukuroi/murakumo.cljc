...
(defn collection
  [name]
  (str "com.etzhayyim.tsukuroi." name))

(def cell-specs {
  :finding_intake {:legacy-cell "finding-intake"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "finding_intake")]
     :required-gates common-gates
     :trigger "manifest cell finding_intake"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :patch_synthesis {:legacy-cell "patch-synthesis"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "patch_synthesis")]
     :required-gates common-gates
     :trigger "manifest cell patch_synthesis"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :charter_rider_scan {:legacy-cell "charter-rider-scan"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "charter_rider_scan")]
     :required-gates common-gates
     :trigger "manifest cell charter_rider_scan"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :patch_validation {:legacy-cell "patch-validation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "patch_validation")]
     :required-gates common-gates
     :trigger "manifest cell patch_validation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :pr_submission {:legacy-cell "pr-submission"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pr_submission")]
     :required-gates common-gates
     :trigger "manifest cell pr_submission"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :closure_verification {:legacy-cell "closure-verification"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "closure_verification")]
     :required-gates common-gates
     :trigger "manifest cell closure_verification"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :silen_tsukuroi_review {:legacy-cell "silen-tsukuroi-review"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "silen_tsukuroi_review")]
     :required-gates common-gates
     :trigger "manifest cell silen_tsukuroi_review"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
